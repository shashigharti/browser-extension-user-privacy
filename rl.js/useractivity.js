export function track(callback) {
  ...
  CommonWeb.trackSession = function (cookieName, defaultGuid) {
    ...
    if (guid === null) {
      ...
      cookie_string =
        cookieName + '=' + guid + '; path/; expires=' + expiration_date.toGMTString()
  ...
  CommonWeb.trackClicks = function (elements, moreProperties) {
    ...
    $.each(elements, function (index, element) {
      $(element).on('click', function (event) {
        ...
        var pageWillUnload =
          element.href && element.target !== '_blank' && !isMetaKey(event)
  ...
  function toClickProperties(event, element, moreProperties) {
    ...
    var elementProperties = {
      element: CommonWeb.Transformations.elementToProperties(element, null),
    }
    var eventProperties = {
      event: CommonWeb.Transformations.eventToProperties(event),
    }
  ...
  function toChangeProperties(event, element, previousValue, moreProperties) {
    ...
    var elementProperties = {
      element: CommonWeb.Transformations.inputElementToProperties(element),
    }
  ...
  function toSubmitProperties(event, element, moreProperties) {
    ...
    var elementProperties = {
      element: CommonWeb.Transformations.formElementToProperties(element),
    }
    var eventProperties = {
      event: CommonWeb.Transformations.eventToProperties(event),
    }
  ...
  jQuery.fn.extend({
    getPath: function (path) {
      ...
      // Add any classes.
      if (typeof klass != 'undefined') cur += '.' + klass.split(/[\s\n]+/).join('.')
  ...
  //         console.log("[Content Script Tracking - Callback]", collection, properties, callback);
  //         window.postMessage({
  //             type: "FROM_PAGE",
  ...
  // window.CommonWeb.Callback = CommonWeb.Endpoint.Callback;
  window.CommonWeb.Callback = callback
  window.CommonWeb.trackClicks()
  window.CommonWeb.trackClicksPassive($('div'))
  window.CommonWeb.trackPageview()
}
