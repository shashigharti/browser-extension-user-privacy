...
const actionAndUpdate = (alphasArray, betasArray, selectedOption, reward) => {
  ...
  console.log('[Content Script ML - Socket]Update Selected Option', selectedOption)
  console.log('[Content Script ML - Socket]Reward', reward)
  console.log('[Content Script ML - Socket]Alphas, Betas', alphasArray, betasArray)
 ...
 * @returns
 */
let clientPreferences = (no_of_clients, index, change_prob_idxs, change_probs) => {
